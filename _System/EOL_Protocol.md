...
6. **Push Command Suggestion**: Output suggested commit message + `.\scripts\push.ps1 "..."` line. Reference `_System/Commit_Convention.md` for format. **DO NOT execute push from agent.**
